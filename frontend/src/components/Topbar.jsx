...
export default function Topbar() {
  ...
  return (
    <header className="topbar sticky top-0 z-30 flex items-center justify-between px-6 h-14">
      <h1 className="font-syne font-semibold text-base" style={{ color: '#E8D5B5' }}>
